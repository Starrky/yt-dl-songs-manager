...
# change config to docker version instead of desktop
...
# Configure cron
RUN printf '%s\n' \
    '0 * * * * cd /home/Script/yt-dl-songs-manager && /usr/bin/python3 sync_music.py sync >> /home/Script/yt-dl-songs-manager/log/sync_cron.log 2>&1' \
